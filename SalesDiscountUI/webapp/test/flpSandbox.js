		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Start UI app title",
									"targetURL": "#salesDiscountSalesDiscountUI-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"salesDiscountSalesDiscountUI-display": {
								"semanticObject": "salesDiscountSalesDiscountUI",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=salesDiscount.SalesDiscountUI",
									"url": sap.ui.require.toUrl("salesDiscount/SalesDiscountUI")
								}
							}
						}
					}
